...
class VisualOdometry():
    ...
    def __init__(self, dataset):
        ...
        self.images_l = self._load_images(dataset.data_path + '/image_00/data')
        self.images_r = self._load_images(dataset.data_path + '/image_01/data')

        self.K_l = dataset.calib.K_cam0
        self.P_l = dataset.calib.P_rect_00

        # Calibration data for the right camera (cam1)
        self.K_r = dataset.calib.K_cam1
        self.P_r = dataset.calib.P_rect_10
        self.gt_poses = [oxts[1] for oxts in dataset.oxts]
...
def main():
    # Define the base directory, date, and drive number
    ...
    plotting.visualize_paths(gt_path, estimated_path, "Stereo Visual Odometry",
                             file_out=os.path.basename(dataset.data_path) + ".html")
